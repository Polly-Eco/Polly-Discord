import { REST, RESTOptions, RESTPostAPIApplicationCommandsJSONBody, Routes } from 'discord.js';
...
export class PollyRestClient extends REST {
    ...
    public async addAllSlashCommands(body: RESTPostAPIApplicationCommandsJSONBody[]) {
        return this.put(Routes.applicationCommands(this.clientId), { body: body })
